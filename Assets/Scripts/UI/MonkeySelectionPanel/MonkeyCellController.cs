...
namespace ServiceLocator.UI
{
    public class MonkeyCellController
    {
        ...
        {
            GameService.Instance.playerserivce.ValidateSpawnPosition(monkeyCellSO.Cost, dragPosition);
        }

        public void MonkeyDroppedAt(Vector3 dropPosition)
        {
            GameService.Instance.playerserivce.TrySpawningMonkey(monkeyCellSO.Type, monkeyCellSO.Cost, dropPosition);
        }
    }
}